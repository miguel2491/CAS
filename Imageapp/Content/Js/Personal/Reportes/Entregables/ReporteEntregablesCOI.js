...
const clsCliente = function () {
    ...
    function GetListaPrincipal(showWait = false, forzeDraw = false) {
        ...
        return new Promise(function (resolve, reject) {
            doAjax("POST", url_Cliente_GetReporteEntregablesCOI, { jsonJS: filtersSearch, id_RV: id_RV }, showWait).done(function (data) {
    ...
    function initTables() {
        ...
        let columnDefs = [
            ...
            { visible: true, orderable: true, searchable: true, targets: 12, width: 100, name: "Entregable_8", data: "Entregable_8", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 13, width: 100, name: "Entregable_9", data: "Entregable_9", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 14, width: 100, name: "Entregable_10", data: "Entregable_10", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 15, width: 100, name: "Entregable_11", data: "Entregable_11", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 16, width: 100, name: "Entregable_12", data: "Entregable_12", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 17, width: 100, name: "Entregable_13", data: "Entregable_13", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 18, width: 100, name: "Entregable_14", data: "Entregable_14", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 19, width: 100, name: "Entregable_15", data: "Entregable_15", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 20, width: 100, name: "Entregable_16", data: "Entregable_16", render: formatDato },
            { visible: true, orderable: true, searchable: true, targets: 21, width: 100, name: "Entregable_17", data: "Entregable_17", render: formatDato },
            
            { visible: true, orderable: true, searchable: true, targets: 22, width: 100, name: "Entregable_18", data: "Entregable_18", render: formatDato }
