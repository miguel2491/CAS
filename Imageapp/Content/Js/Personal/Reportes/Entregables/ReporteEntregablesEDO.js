...
const clsCliente = function () {
    ...
    function GetListaPrincipal(showWait = false, forzeDraw = false) {
        ...
        return new Promise(function (resolve, reject) {
            doAjax("POST", url_Cliente_GetReporteEntregablesEDO, { jsonJS: filtersSearch, id_RV: id_RV }, showWait).done(function (data) {
    ...
    function initTables() {
        ...
        let columnDefs = [
            ...
            { visible: true, orderable: true, searchable: true, targets: 1, width: 320, name: "nombre_razon", data: "nombre_razon" },
