...
const clsCliente = function () {
    ...
    var $mes = $("#fl_mes");
    var $periodicidad = $("#fl_periodicidad");
    ...
    function GetListaPrincipal(showWait = false, forzeDraw = false) {
        ...
        filter.periodicidad = $periodicidad.val();
        let filtersSearch = JSON.stringify(filter);

        return new Promise(function (resolve, reject) {
            doAjax("POST", url_Cliente_GetReporteEntregablesNomina, { jsonJS: filtersSearch, id_RV: id_RV }, showWait).done(function (data) {
    ...
    function initTables() {
        ...
        let columnDefs = [
            ...
            { visible: true, orderable: true, searchable: true, targets: 2, width: 120, name: "periodo", data: "periodo" },
            { visible: true, orderable: true, searchable: true, targets: 3, width: 120, name: "periodicidad", data: "periodicidad" },
