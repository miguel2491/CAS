...
namespace sat_ws
{
    class CFDINominaObject
    {
        ...
        private DataTable conceptos =  new DataTable();
        private string tipoRelacion = "";
        private DataTable cfdiRelacionados = new DataTable();
        ...
        private string numeroSerieCertificadoSAT = "";

        private string complementoPagosFechaPago = "";
        private string complementoPagosMonto = "";
        private string complementoPagosMoneda = "";
        ...
        public DataTable CFDIRelacionados
        {
            get
            {
        ...
        public string NumeroSerieCertificadoSAT
        {
            get
            {
                return numeroSerieCertificadoSAT;
            }

            set
            {
                numeroSerieCertificadoSAT = value;
            }
        }
        

        public string ComplementoPagosFechaPago
        {
            get
            {
                return complementoPagosFechaPago;
            }

            set
            {
                complementoPagosFechaPago = value;
            }
        }

        public string ComplementoPagosMonto
        {
            get
            {
                return complementoPagosMonto;
            }

            set
            {
                complementoPagosMonto = value;
            }
        }

        public string ComplementoPagosMoneda
        {
            get
            {
                return complementoPagosMoneda;
            }

            set
            {
                complementoPagosMoneda = value;
            }
        }
