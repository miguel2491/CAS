...
namespace sat_ws
{
    class GeneraPDFFactura
    {
        private static CultureInfo _ci;
        private static CultureInfo _ci2;
        public static iTextSharp.text.Image Logo = Image.GetInstance("\\" + "Logotipo.png");
        ...
        {
            Logo = Image.GetInstance("\\" + "Logotipo.png");
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                table.AddCell(new Phrase(new Chunk("Version CFDI: " + oCFDINomina.Version + " - Versión Nómina: " + VersionNomina , BoldFont)));
    ...
    public class pdfPageEventHandlerFactura : PdfPageEventHelper
    {
        #region "variables"
        //private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
