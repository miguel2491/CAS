...
namespace sat_ws
{
    class ReadXMLCFDI33Nomina12ToObject
    {
        //private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public static bool Get(DataSet dsXMLCFDI, DataSet dsXMLCFDINomina, XDocument xmlDoc, string VersionNomina, string RutaXML)
        {
            ...
            try
            {
                ...
                foreach (DataRow dato in dsXMLCFDI.Tables[4].Rows)
                {
                ...
                try
                {
                    if (dsXMLCFDI.Tables["Traslado"] != null)
                    {
                ...
                try
                {
                    if (dsXMLCFDI.Tables["Retencion"] != null)
                    {
                ...
                try
                {
                    if (dsXMLCFDI.Tables["Impuestos"] != null)
                    {
                ...
                //Si la variable VersionNomina es mayor a cera quiere decir que hablamos de un comprobante con complemento de nónima, así que agregamos sus nodos a la representación impresa
                ...
                GeneraPDFNomina.GeneraRepresentacionImpresa(RutaXML.Replace(".xml", ".pdf").Replace(".XML", ".pdf").Replace(".procesado", ""), CFDINomina, HTPercepciones, HTDeducciones, VersionNomina);
