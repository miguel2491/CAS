const mdlContactosCliente = function () {
    //! Doom del modal
    var $formContactos = $("#frmContactos"),
        $modalContactos = $("#mdlContactos"),
        eventModal = 'BTN-CONTATOS',
        tblPrincipal = null,
        objOriginal = {};
    ...
    async function setDatosModal() {
        ...
        $modalContactos.modal();//Mostrar modal
    ...
    function GetContactosCliente(showWait = false) {
        ...
        let id_RVA = objClsCliente.getlistaPermisos()["BTN-CONTACTOS"].id_RVA;
    ...
    function enviarStoredProcedure() {
        let objSend = {};
        //! Valildar formulario
        if (eventModal == 'BTN-CONTACTOS') {
            if (!$formContactos.valid())
    ...
    function resetearModal() {
        $formContactos.validate().resetForm();
    ...
    function inicializarValidaciones() {
        ...
        $formContactos.validate(principalForm);
    }
