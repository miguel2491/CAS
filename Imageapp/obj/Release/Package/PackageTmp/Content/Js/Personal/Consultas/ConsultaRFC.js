...
const clsClienteRIF = function () {
    ...
    function initTables() {
        ...
        let columnDefs = [
            ...
            { visible: true, orderable: true, searchable: true, targets: 17, width: 150, name: "retencion_iva", data: "retencion_iva", title: "Retención IVA" },
            { visible: true, orderable: true, searchable: true, targets: 18, width: 150, name: "retencion_isr", data: "retencion_isr", title: "Retención ISR" },
            { visible: true, orderable: true, searchable: true, targets: 19, width: 150, name: "total", data: "total", title: "Total" },
            { visible: true, orderable: true, searchable: true, targets: 20, width: 350, name: "conceptos", data: "conceptos", render: maxContent, title: "Conceptos" },
            { visible: true, orderable: true, searchable: true, targets: 21, width: 100, name: "moneda", data: "moneda" , title: "Moneda"},
            { visible: true, orderable: true, searchable: true, targets: 22, width: 150, name: "total_original", data: "total_original" , title: "Total original"},
            { visible: true, orderable: true, searchable: true, targets: 23, width: 150, name: "tipo_cambio", data: "tipo_cambio" , title: "Tipo cambio"},
            { visible: true, orderable: true, searchable: true, targets: 24, width: 150, name: "forma_pago", data: "forma_pago", title: "Forma pago" },
            { visible: true, orderable: true, searchable: true, targets: 25, width: 150, name: "metodo_pago", data: "metodo_pago" , title: "Método pago"},
            
            { visible: true, orderable: true, searchable: true, targets: 26, width: 350, name: "monto", data: "monto", title: "Monto" },
            { visible: true, orderable: true, searchable: true, targets: 27, width: 120, name: "usoCFDI", data: "usoCFDI", title:"Uso CFDI" },
            { visible: true, orderable: true, searchable: true, targets: 28, width: 150, name: "ieps", data: "ieps", title: "IEPS" },
            { visible: true, orderable: true, searchable: true, targets: 29, width: 150, name: "retencion_ieps", data: "retencion_ieps", title:"Retención IEPS" },
            { visible: true, orderable: true, searchable: true, targets: 30, width: 150, name: "traslado_local", data: "traslado_local", title: "Total traslado local" },
            { visible: true, orderable: true, searchable: true, targets: 31, width: 150, name: "retencion_local", data: "retencion_local", title: "Total retención local" },
            { visible: false, orderable: false, searchable: false, targets: 32, width: 100, name: "isr_nomina", data: "isr_nomina", title: "ISR nómina" },
            { visible: false, orderable: false, searchable: false, targets: 33, width: 130, name: "subsidio_nomina", data: "subsidio_nomina", title: "Subsidio nómina" },
            ...
            { visible: false, orderable: false, searchable: false, targets: 35, width: 130, name: "RFCEmisor", data: "RFCEmisor" },
            { visible: false, orderable: false, searchable: false, targets: 36, width: 250, name: "nombre_emisor", data: "nombre_emisor" },           
            { visible: false, orderable: false, searchable: false, targets: 37, width: 150, name: "fecha_pago", data: "fecha_pago" },
            { visible: false, orderable: false, searchable: false, targets: 38, width: 80, name: "version", data: "version" },            
        ...
        let columnDefs2 = [
            ...
            { visible: true, orderable: true, searchable: true, targets: 18, width: 150, name: "retencion_isr", data: "retencion_isr", title: "Retención ISR" },
            { visible: true, orderable: true, searchable: true, targets: 19, width: 150, name: "total", data: "total", title: "Total" },
            { visible: true, orderable: true, searchable: true, targets: 20, width: 350, name: "conceptos", data: "conceptos", title: "Conceptos" },
            { visible: true, orderable: true, searchable: true, targets: 21, width: 100, name: "moneda", data: "moneda", title: "Moneda" },
            { visible: true, orderable: true, searchable: true, targets: 22, width: 150, name: "total_original", data: "total_original", title: "Total original" },
            { visible: true, orderable: true, searchable: true, targets: 23, width: 150, name: "tipo_cambio", data: "tipo_cambio", title: "Tipo cambio" },
            { visible: true, orderable: true, searchable: true, targets: 24, width: 150, name: "forma_pago", data: "forma_pago", title: "Forma pago" },
            ...
            { visible: true, orderable: true, searchable: true, targets: 30, width: 150, name: "traslado_local", data: "traslado_local", title: "Total traslado local" },
            { visible: true, orderable: true, searchable: true, targets: 31, width: 150, name: "retencion_local", data: "retencion_local", title: "Total retención local" },
            { visible: true, orderable: true, searchable: true, targets: 32, width: 150, name: "divisa_opc", data: "divisa_opc", title: "Divisa" },
            { visible: true, orderable: true, searchable: true, targets: 33, width: 150, name: "nombre_xml", data: "nombre_xml", title: "XML" },

            

            
            { visible: false, orderable: false, searchable: false, targets: 34, width: 130, name: "RFCReceptor", data: "RFCReceptor" },
            { visible: false, orderable: false, searchable: false, targets: 35, width: 250, name: "nombre_receptor", data: "nombre_receptor" },            
            { visible: false, orderable: false, searchable: false, targets: 36, width: 150, name: "fecha_pago", data: "fecha_pago" },
            { visible: false, orderable: false, searchable: false, targets: 37, width: 80, name: "version", data: "version" },            
            { visible: false, orderable: false, searchable: false, targets: 38, width: 150, name: "tipo_comprobante", data: "tipo_comprobante" },            
            { visible: false, orderable: false, searchable: false, targets: 39, width: 150, name: "impuesto_retenido", data: "impuesto_retenido" },
            { visible: false, orderable: false, searchable: false, targets: 40, width: 250, name: "cfdi_relacionados", data: "cfdi_relacionados" },
            { visible: false, orderable: false, searchable: false, targets: 41, width: 200, name: "tipo_relacion_cfdi", data: "tipo_relacion_cfdi" },
            { visible: false, orderable: false, searchable: false, targets: 42, width: 150, name: "url_xml", data: "url_xml" },
            { visible: true, orderable: true, searchable: false, targets: 43, width: 150, name: "fecha_validacion", data: "fecha_validacion", title: "Fecha de validación" },
            { visible: true, orderable: true, searchable: false, targets: 44, width: 150, name: "EFOS", data: "EFOS", title: 'EFOS' },
